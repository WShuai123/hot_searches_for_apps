...
+ [人工智能|机器学习——循环神经网络的简洁实现](https://blog.csdn.net/admin_maxin/article/details/134621448)
...
+ [【数据库】表的连接在执行时的算法解析，嵌套循环连接算法的几种实现，多表连接中表的数量会影响什么](https://blog.csdn.net/senllang/article/details/134630746)

+ [安卓使用MediaRecorder录制音频的详细使用](https://blog.csdn.net/CSqingchen/article/details/134599828)
